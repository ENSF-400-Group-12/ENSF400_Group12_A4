...
const TYPE_PATTERNS = [
  { re: /jumpsuit/i, type: 'Jumpsuit' },
  { re: /romper/i, type: 'Romper' },
  { re: /dress(?!.*shirt)/i, type: 'Dress' },
  { re: /bodysuit/i, type: 'Bodysuit' },
  { re: /cami|camisole/i, type: 'Camisole' },
  { re: /tank[\s_-]?top|\btank\b|halter/i, type: 'Tank' },
  { re: /blouse/i, type: 'Blouse' },
  { re: /tee|t-?shirt|tshirt|\btop\b/i, type: 'T-Shirt' },
  { re: /hoodie|hoody|sweatshirt|zip[\s_-]?up|zipup|pullover/i, type: 'Hoodie' },
  { re: /cardigan/i, type: 'Cardigan' },
  ...
  { re: /leggings|legging/i, type: 'Leggings' },
  ...
  { re: /heel|stiletto|pump|pumps|kitten[\s_-]?heel/i, type: 'Heels' },
  { re: /flat|ballerina|mary[\s_-]?jane/i, type: 'Flats' },
  { re: /dress[\s_-]?boot/i, type: 'Dress Boots' },
  { re: /boot\b|boots|chelsea|combat[\s_-]?boot/i, type: 'Boots' },
  { re: /sandal|slides|flip[\s_-]?flop/i, type: 'Sandals' },
  { re: /loafer|oxford|derby|mule|clog/i, type: 'Shoes' },
